...
public class ImproveRMSItemBasedRecommendEvaluatorSample {
	public static void main(String[] args) throws IOException, TasteException{
		...
		System.out.println("----------random 0.9 training percentage result using RMS----------");
		System.out.println(score);
		System.out.println("-------------------------------------------------------------------");
		
		score = evaluator.evaluate(builder2, null, model, 0.9, 1.0);
		System.out.println("----------random 0.9 training percentage result using RMS with similarity threshold----------");
		System.out.println(score);
		System.out.println("---------------------------------------------------------------------------------------------");
	}
}
