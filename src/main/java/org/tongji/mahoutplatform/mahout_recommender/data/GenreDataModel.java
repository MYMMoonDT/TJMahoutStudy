...
public class GenreDataModel extends AbstractDataModel {
   ...
   */
  public GenreDataModel(FastByIDMap<FastIDSet> userData) {
    this(userData, null);
  }
   ...
   */
  public GenreDataModel(FastByIDMap<FastIDSet> userData, FastByIDMap<FastByIDMap<Long>> timestamps) {
   ...
   */
  @Deprecated
  public GenreDataModel(DataModel dataModel) throws TasteException {
