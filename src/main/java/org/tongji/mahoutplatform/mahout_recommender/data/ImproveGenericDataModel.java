 ...
 * </p>
 */
public final class ImproveGenericDataModel extends AbstractDataModel {
  
  private static final Logger log = LoggerFactory.getLogger(ImproveGenericDataModel.class);
   ...
   */
  public ImproveGenericDataModel(FastByIDMap<PreferenceArray> userData) {
    this(userData, null);
  }
   ...
   */
  public ImproveGenericDataModel(FastByIDMap<PreferenceArray> userData, FastByIDMap<FastByIDMap<Long>> timestamps) {
   ...
   */
  @Deprecated
  public ImproveGenericDataModel(DataModel dataModel) throws TasteException {
